//
//  ProInTableViewController.m
//  S-MixControl
//
//  Created by chenq@kensence.com on 16/1/22.
...
#import "ProConnect.h"
@interface ProInTableViewController ()<GCDAsyncUdpSocketDelegate>
{
...
@implementation ProInTableViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    [self.tableView registerClass:[UITableViewCell class] forCellReuseIdentifier:@"ProIn"];
    
    
    _array = @[@"RGB ",@" YUV444",@" YUV422",@" BT656"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"ProIn" forIndexPath:indexPath];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSInteger length = make_boardcard_pack_5555(METHOD_SET, CARD_INPUT,cardid,V_COLOR_SPACE_OUTPUT, 1,&bull, buf);
